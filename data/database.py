...
points_names =[
    ...
    'Masjid Al-Husna',
    'Ppum Federal',
    'KL 1102 Masjid Ar-Rahman UM, Lingkungan Budi'
    'Mahsa University / Intan',
...
connect_points(points['KL 1102 Masjid Ar-Rahman UM, Lingkungan Budi'],points['UM CENTRAL'],MODE_WALKING)
connect_points(points['UM CENTRAL'],points['Mahsa University / Intan'],MODE_WALKING)
...
connect_points(points['Mahsa University / Intan'],points['Mid Valley Megamall'],MODE_BUS)
connect_points(points['Masjid Al-Husna'],points['Ppum Federal'],MODE_BUS)
connect_points(points['Ppum Federal'],points['KL 1102 Masjid Ar-Rahman UM, Lingkungan Budi'],MODE_BUS)
