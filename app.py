...
def getBounds(test_path):
    # test_path should be deleted later!
    # and is the input for getBounds gonna be in the same format (dictionary with key = 'path')?
    test_path = {'path': [(3.10554, 101.66232), (3.10554, 101.66257), (3.10592, 101.66257), (3.10592, 101.66335),
    ...
    path_tuples = test_path['path']

    southwest_point = min(path_tuples)
    northeast_point = max(path_tuples)
